...
class Image:
    ...
    def annotate_camera_image(self,robot, event_type,event2, done):
        # get an image with face annotations
    ...
    def on_new_camera_image(self,robot, event_type, event1_raw, done):
        ...
        #saving image that is seen for reference this can be used to make datasets
...
# This function looks if there is any face and implements gesture detection
